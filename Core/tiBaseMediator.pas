...
type
  ...
  protected
    ...
    // Set the GUI in a  clear state reagrdless Subject state and content
    ...
    property SettingUp: boolean read FSettingUp write FSettingUp;
  public
...
begin
  if not FSettingUp and Assigned(FSubject) then
  begin
    GUIToObject;
    TestIfValid;
  end;
